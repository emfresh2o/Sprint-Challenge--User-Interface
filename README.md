...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    --> Semantic HTML refers to HTML elements that has meaning where human and computers can easily identify and understand every codes.
...
4. Explain why git is valuable to a team of developers.
    ...
    --> It enables collaboration function and changes of work between team of developers, keeping track of every changes made from different contributors or collaborators.

5. Define mobile-first design in your own words.

    --> mobile-first design means that you start designing your website from smaller devices or screen first for a better user experience.
